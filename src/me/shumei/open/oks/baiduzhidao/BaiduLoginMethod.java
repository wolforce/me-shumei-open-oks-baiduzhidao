...
import me.shumei.open.oks.baiduzhidao.tools.HttpUtil;
...
public class BaiduLoginMethod extends CommonData {
    ...
    public static HashMap<String, String> loginBaiduAndroid(String user, String pwd) throws IOException
    {
        ...
        for(int i=0;i<RETRY_TIMES;i++)
        {
            ...
            String uid = doc.getElementsByAttributeValue("name", "uid").val();
            String type = doc.getElementsByAttributeValue("name", "type").val();
            String regtype = doc.getElementsByAttributeValue("name", "regtype").val();
            String adapter = doc.getElementsByAttributeValue("name", "adapter").val();
            String skin = doc.getElementsByAttributeValue("name", "skin").val();
            String regist_mode = doc.getElementsByAttributeValue("name", "regist_mode").val();
            String login_share_strategy = doc.getElementsByAttributeValue("name", "login_share_strategy").val();
            String client = doc.getElementsByAttributeValue("name", "client").val();
            String clientfrom = doc.getElementsByAttributeValue("name", "clientfrom").val();
            String isphone = doc.getElementsByAttributeValue("name", "isphone").val();
            String loginmerge = doc.getElementsByAttributeValue("name", "loginmerge").val();
            
            postDatas.put("username", user);
            postDatas.put("password", pwd);
            postDatas.put("action", "0");
            postDatas.put("u", u);
            postDatas.put("tpl", tpl);
            postDatas.put("tn", tn);
            postDatas.put("pu", pu);
            ...
            postDatas.put("uid", uid);
            postDatas.put("type", type);
            postDatas.put("regtype", regtype);
            postDatas.put("adapter", adapter);
            postDatas.put("skin", skin);
            postDatas.put("regist_mode", regist_mode);
            postDatas.put("login_share_strategy", login_share_strategy);
            postDatas.put("client", client);
            postDatas.put("clientfrom", clientfrom);
            postDatas.put("isphone", isphone);
            postDatas.put("loginmerge", loginmerge);
            ...
            if (isNeedCaptcha)
            {
                ...
                uid = doc.getElementsByAttributeValue("name", "uid").val();
                type = doc.getElementsByAttributeValue("name", "type").val();
                regtype = doc.getElementsByAttributeValue("name", "regtype").val();
                adapter = doc.getElementsByAttributeValue("name", "adapter").val();
                skin = doc.getElementsByAttributeValue("name", "skin").val();
                regist_mode = doc.getElementsByAttributeValue("name", "regist_mode").val();
                login_share_strategy = doc.getElementsByAttributeValue("name", "login_share_strategy").val();
                client = doc.getElementsByAttributeValue("name", "client").val();
                clientfrom = doc.getElementsByAttributeValue("name", "clientfrom").val();
                isphone = doc.getElementsByAttributeValue("name", "isphone").val();
                loginmerge = doc.getElementsByAttributeValue("name", "loginmerge").val();
