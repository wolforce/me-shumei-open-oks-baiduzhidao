        ...
        try{
            ...
            for(int i=0;i<RETRY_TIMES;i++)
            {
                try {
                    ...
                    //签到成功 {"errorNo":0,"data":{"wealth":0,"expToday":2,"expTomorrow":2,"signInDataNum":1,"today":"2014-08-27","signTaskType":"65","cm":100509},"errorMsg":"success"}
                    //尚未签到 {"errorNo":2,"data":{"wealth":0,"expToday":8,"expTomorrow":10,"signInDataNum":7,"today":"2014-08-27","signTaskType":"65","cm":100509},"errorMsg":"已签到"}
                    ...
                    int errorNo = jsonObj.optInt("errorNo");
                    if(errorNo == 0 || errorNo == 2)
                    {
                        resultFlag = "true";
                        JSONObject dataJsonObj = jsonObj.optJSONObject("data");
                        String today = dataJsonObj.optString("today");
                        String signInDataNum = dataJsonObj.getString("signInDataNum");
//                      String expToday = dataJsonObj.optString("expToday");
//                      String expTomorrow = dataJsonObj.optString("expTomorrow");
